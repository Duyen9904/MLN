...
{
  id: "khaithacthan-gd1",
  src: "/src/assets/khaithacthan-gd1.jpg",
  ...
  details: {
    ...
    significance: "Cái nôi ra đời của giai cấp công nhân Việt Nam, nơi bùng nổ nhiều phong trào đấu tranh sớm nhất"
  },
  additionalImages: [
    {
      src: "/src/assets/placeholder-mining-1.jpg",
      alt: "Công nhân mỏ than làm việc",
      caption: "Công nhân mỏ than trong ca làm việc"
    },
    {
      src: "/src/assets/placeholder-mining-2.jpg",
...
{
  id: "nhamaydetnamdinh",
  src: "/src/assets/nhamaydetnamdinh.jpg",
  ...
  details: {
    ...
    significance: "Trung tâm công nghiệp lớn và là điểm bùng phát nhiều phong trào đấu tranh công nhân"
  },
  additionalImages: [
    {
      src: "/src/assets/placeholder-textile-1.jpg",
      alt: "Công nhân dệt trong nhà máy",
      caption: "Công nhân dệt làm việc trong điều kiện khắc nghiệt"
    },
    {
      src: "/src/assets/placeholder-textile-2.jpg",
...
},
{
  ...
  details: {
    period: "1930–1945",
    location: "Toàn quốc",
    significance: "Đảng Cộng sản Việt Nam ra đời, chấm dứt khủng hoảng đường lối cách mạng, xác lập vai trò lãnh đạo của giai cấp công nhân."
  },
  additionalImages: [
    {
      src: "/src/assets/placeholder-revolution-1.jpg",
      alt: "Cuộc mít-tinh của công nhân",
      caption: "Cuộc mít-tinh lớn của công nhân"
    },
    {
      src: "/src/assets/placeholder-revolution-2.jpg",
...
{
  id: "cauchuyenlacado",
  src: "/src/assets/cauchuyenlacado.jpg",
  ...
  details: {
    ...
    significance: "Biểu tượng của phong trào công nhân và sự khẳng định vai trò lãnh đạo của Đảng Cộng sản Việt Nam"
  },
  additionalImages: [
    {
      src: "/src/assets/placeholder-flag-1.jpg",
      alt: "Công nhân treo lá cờ đỏ",
      caption: "Công nhân treo lá cờ đỏ trong phong trào đấu tranh"
    },
    {
      src: "/src/assets/placeholder-flag-2.jpg",
